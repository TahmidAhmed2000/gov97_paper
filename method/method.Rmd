...
```{r}
# Load data
ethics <- read_csv("/Users/tahmidahmed/Desktop/gov97/Gov97/data/ethics_papers.csv") %>%
...
business <- read_csv("/Users/tahmidahmed/Desktop/gov97/Gov97/data/business_ranking.csv") %>%
...
GDP_rank <- read_csv("/Users/tahmidahmed/Desktop/gov97/Gov97/data/GDP_ranking.csv") %>%
...
GDP <- read_csv("/Users/tahmidahmed/Desktop/gov97/Gov97/data/GDP.csv") %>%
  select('Country Name', '2019') %>%
  rename("gdp" = "2019")
...
innovation <- read_csv("/Users/tahmidahmed/Desktop/gov97/Gov97/data/innovation.csv") %>%
...
```{r}
# Load learning data
atop <- data.table::fread("/Users/tahmidahmed/Desktop/gov97/Gov97/data/atop5_0sy.csv")
